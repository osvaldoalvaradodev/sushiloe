...
<div class="banner">
          ...
          <div class="caption">
            <div class="caption-wrapper">
              ...
              <i class="fa fa-thumbs-o-up fa-5x animated bounceInDown"></i>
              <h1 class="animated bounceInUp">El Mejor Sushi de Chiloe</h1>
              
              <p class="animated bounceInLeft">Consulta por nuestras Pizarras y Ofertas del Día</p>
...
Tempura chiken 9 piezas (pollo, palta, philadelphia). +
4 rollitos primavera o jamón queso. +
2 bebidas, te o café. </p>


 <p><b>Promo Sushi Beef $6500</b> Tempura beef (carne, philadelphia y cebollín) +
    ...
    <div class="panel-heading" role="tab">
      <h4 class="panel-title">
        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
         <i class="fa fa-cutlery"></i> Carta Sandwich
        </a>
      </h4>
    </div>
    ...
    <div class="panel-heading" role="tab">
      <h4 class="panel-title">
        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
         <i class="fa fa-cutlery"></i> Hamburguesas
        </a>
      </h4>
    </div>
    ...
    <div class="panel-heading" role="tab">
      <h4 class="panel-title">
        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseSix" aria-expanded="false" aria-controls="collapseFive">
         <i class="fa fa-cutlery"></i> Platos
        </a>
      </h4>
    </div>
  ...
  <div class="panel panel-default">
    <div class="panel-heading" role="tab">
      <h4 class="panel-title">
        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseSeven" aria-expanded="false" aria-controls="collapseFive">
         <i class="fa fa-cutlery"></i> Para Picar
        </a>
      </h4>
    </div>
    <div id="collapseSeven" class="panel-collapse collapse" role="tabpanel">
      <div class="panel-body">
         ...
         <p>
         Varitas de Pollo Apanados<br>(12 unidades)
          <p>
         </div>
...
<div class="clearfix food-list"><div class="pull-left"></div>
  ...
  <div class="panel panel-default">
    <div class="panel-heading" role="tab">
      <h4 class="panel-title">
        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse8" aria-expanded="false" aria-controls="collapseFive">
         <i class="fa fa-cutlery"></i> Carta Wok
        </a>
      </h4>
    </div>
...
<div id="foods"  class=" clearfix grid"> 
    <figure class="effect-oscar  wowload fadeInUp">
        ...
        <figcaption>
            <h2>SUSHI</h2>
            <p>Detalles<br>
            <a href="images/portfolio/1.jpg" title="1" data-gallery>Ver mas...</a></p>            
        </figcaption>
    </figure>
     <figure class="effect-oscar  wowload fadeInUp">
     ...
     <figure class="effect-oscar  wowload fadeInUp">
        ...
        <figcaption>
             <h2>PIZZA</h2>
            <p>Detalles<br>
            <a href="images/portfolio/4.jpg" title="1" data-gallery>Ver mas...</a></p>            
        </figcaption>
    </figure>
     ...
     <figure class="effect-oscar  wowload fadeInUp">
        ...
        <figcaption>
              <h2>LOCAL</h2>
            <p>Interior...<br>
            <a href="images/portfolio/5.jpg" title="1" data-gallery>Ver mas...</a></p>            
        </figcaption>
    </figure>
    <figure class="effect-oscar  wowload fadeInUp">
        ...
        <figcaption>
              <h2>LOCAL</h2>
            <p>Exterior...<br>
            <a href="images/portfolio/6.jpg" title="1" data-gallery>Ver mas...</a></p>            
        </figcaption>
    </figure>
        ...
        <figcaption>
            ...
            <p>La Condená<br>
            <a href="images/portfolio/7.jpg" title="1" data-gallery>Ver mas...</a></p>            
        </figcaption>
    </figure>
        ...
        <figcaption>
             <h2>Cerveza Artesanal</h2>
            <p>La Condená<br>
            <a href="images/portfolio/8.jpg" title="1" data-gallery>Ver mas...</a></p>            
        </figcaption>
    </figure>
        ...
        <figcaption>
               <h2>Cerveza Artesanal</h2>
            <p>La Condená<br>
            <a href="images/portfolio/9.jpg" title="1" data-gallery>Ver mas...</a></p>            
        </figcaption>
    </figure>
</div>
<!-- works -->
...
<div id="partners" class="container spacer ">
	<h2 class="text-center  wowload fadeInUp">Recomiendanos en Tripadvisor</h2>
  <div class="clearfix">    
    <div class="col-sm-6 col-sm-offset-3">

<center>
<div id="TA_excellent273" class="TA_excellent">
<ul id="4X4HmdHmT" class="TA_links QnsTdH7SC">
<li id="6Ki1KMt6elx" class="Pz3eVKzLtKSX">
...
<script src="https://www.jscache.com/wejs?wtype=excellent&amp;uniq=273&amp;locationId=10258537&amp;lang=es_CL&amp;display_version=2"></script></center>
<!--
...
<!-- team -->
<!--
<h3 class="text-center  wowload fadeInUp">Nuestros Chefs</h3>
<p class="text-center  wowload fadeInLeft">Lorem ipsum dolorum</p>
...
<div class="row text-center  wowload fadeInDownBig">
	<div class="col-sm-3 col-xs-6">
	<i class="fa fa-smile-o  fa-5x"></i><h4>La mejor atencion</h4>
	</div>
	<div class="col-sm-3 col-xs-6">
	<i class="fa fa-thumbs-up  fa-5x"></i><h4>Menus Variados</h4>
	</div>
	<div class="col-sm-3 col-xs-6">
	<i class="fa fa-history  fa-5x"></i><h4>De 12:30 a 23:00</h4>
	</div>
	<div class="col-sm-3 col-xs-6">
	<i class="fa fa-map-marker fa-5x"></i><h4>En el centro de Quellón</h4>
	</div>
</div>
</div>
</div>
...
<h2 class="text-center  wowload fadeInUp">Contactanos!</h2>
...
<script src='https://maps.googleapis.com/maps/api/js?key=AIzaSyBf0C3Y9dlOcsjtiGg43K0XptlsApCA3Bk&sensor=false&extension=.js'></script> 
